package hadoop.homework.utils.ip;
...
public class IPSeeker {
    ...
    private static final String IP_FILE = System.getProperty("user.dir") + "/src/QQWry.Dat";
    ...
    private IPSeeker() {
        ...
        b3 = new byte[3];
        try {
            String file = System.getProperty("user.dir") + "/src/QQWry.Dat";
            ipFile = new RandomAccessFile(System.getProperty("user.dir") + "/src/QQWry.Dat", "r");
        } catch (FileNotFoundException e) {
            System.out.println(IPSeeker.class.getResource("/src/QQWry.dat")
                    .toString());
